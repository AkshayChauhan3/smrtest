...
class _LiveRadarScreenState extends ConsumerState<LiveRadarScreen> {
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          _buildTelemetryCard(
                            label: 'INFLOW SENSOR',
                            value: '${84 + (_streamTick * 3 % 20)} PAX/M',
                          ...
                          _buildTelemetryCard(
                            ...
                            value: '${62 + (_streamTick * 2 % 15)} PAX/M',
  ...
  Widget _buildSensorTelemetryBanner() {
    return Container(
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.sensors_rounded, color: AppTheme.signalGreen, size: 24),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Polling telemetry every 5.0s from ${AppConfig.baseUrl}',
